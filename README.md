...
* Tag policy creation in AWS Organizations (management account).
  <p align="center"> <img src="img/tag-policy-create.png" alt="tag-policy-create" width="800"/> </p>
  
* Attaching the tag policy to OU/account.
  <p align="center"> <img src="img/tag-policy-attach.jpg" alt="tag-policy-attach" width="800"/> </p>
  
* EC2 launch succeeded with required tags present.
  <p align="center"> <img src="img/correct-tags.jpg" alt="correct-tags" width="800"/> </p>
  <p align="center"> <img src="img/success-with-tags.jpg" alt="success-with-tags" width="800"/> </p>
  <p align="center"> <img src="img/launched ec2.jpg" alt="launched ec2" width="800"/> </p>
  
* EC2 launch blocked when required tags are missing — console error shown.
